...
Therefore, LLM-generated text is not allowed in issues, in PRs, in the
wiki, on mailinglists, or any other part of the project.

(Machine translation, which has the same semantics as the original, is
not considered LLM-generated text.  There is no intent to exclude
those relying on translation.)
